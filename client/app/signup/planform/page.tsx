      ...
      <div className="flex min-h-[70vh] w-full max-w-5xl flex-col items-start justify-center gap-10">
        ...
        <div className="flex w-full flex-col gap-4">
          ...
          <table className="text-black">
            <tbody>
              <tr className="flex flex-wrap items-center border-b border-gray-300 text-xs md:text-base">
                <td className="w-full py-3 text-center md:w-[35%] md:py-4 md:text-left">
                  Monthly price
                </td>
                <td
                  className="
                  w-[calc(100%/4)] pb-4 text-center font-semibold text-black/50 md:w-[calc(65%/4)] 
                  md:pb-0
                  "
                >
                  THB 99
